...
\includegraphics{05-RegLogist_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pdata <-}\StringTok{ }\KeywordTok{predict}\NormalTok{(m1, }\DataTypeTok{newdata =}\NormalTok{ chd, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{)}
\KeywordTok{confusionMatrix}\NormalTok{(}\DataTypeTok{data =} \KeywordTok{as.numeric}\NormalTok{(pdata}\OperatorTok{>}\FloatTok{0.5}\NormalTok{), }\DataTypeTok{reference =}\NormalTok{ chd}\OperatorTok{$}\NormalTok{CHD)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{06-Mapas_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(MAPA_RS[MAPA_RS}\OperatorTok{$}\NormalTok{NOME }\OperatorTok{==}\StringTok{'SANTA ROSA'}\NormalTok{,], }
    \DataTypeTok{axes=}\StringTok{"TRUE"}\NormalTok{,  }\DataTypeTok{main=}\StringTok{"Mapa do município de Santa Rosa - RS"}\NormalTok{, }\DataTypeTok{border=}\KeywordTok{gray}\NormalTok{(}\FloatTok{0.5}\NormalTok{), }\DataTypeTok{lwd=}\NormalTok{.}\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{06-Mapas_files/figure-latex/unnamed-chunk-4-1.pdf}
...
\includegraphics{06-Mapas_files/figure-latex/unnamed-chunk-5-1.pdf}
...
\includegraphics{06-Mapas_files/figure-latex/unnamed-chunk-6-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tm_shape}\NormalTok{(RS_}\DecValTok{2013}\NormalTok{_MAPA) }\OperatorTok{+}
\StringTok{    }\KeywordTok{tm_polygons}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"PIB"}\NormalTok{, }\StringTok{"POPULACAO"}\NormalTok{), }
        ...
        \DataTypeTok{breaks=}\KeywordTok{list}\NormalTok{(}\KeywordTok{quantile}\NormalTok{(RS_}\DecValTok{2013}\NormalTok{_MAPA}\OperatorTok{$}\NormalTok{POPULACAO),}\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\OtherTok{Inf}\NormalTok{,}\DecValTok{100000}\NormalTok{,}\DecValTok{200000}\NormalTok{,}\OtherTok{Inf}\NormalTok{)),}
...
\KeywordTok{tm_style_grey}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{06-Mapas_files/figure-latex/unnamed-chunk-9-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tm_shape}\NormalTok{(RS_}\DecValTok{2013}\NormalTok{_MAPA[RS_}\DecValTok{2013}\NormalTok{_MAPA}\OperatorTok{$}\NormalTok{COREDE }\OperatorTok{==}\StringTok{'Sul'}\NormalTok{,]) }\OperatorTok{+}
\StringTok{    }\KeywordTok{tm_polygons}\NormalTok{(}\StringTok{"POPULACAO"}\NormalTok{, }\DataTypeTok{title=}\StringTok{"Pop"}\NormalTok{, }\DataTypeTok{style=}\StringTok{"kmeans"}\NormalTok{, }\DataTypeTok{text=}\StringTok{"Label_N"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{tm_facets}\NormalTok{(}\StringTok{"COREDE"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{tm_text}\NormalTok{(}\StringTok{"Label_N"}\NormalTok{,}\DataTypeTok{scale=}\FloatTok{0.45}\NormalTok{)}\OperatorTok{+}
\KeywordTok{tm_style_grey}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{06-Mapas_files/figure-latex/unnamed-chunk-10-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Coredes.agg=}\KeywordTok{aggregate}\NormalTok{(Coredes[,}\DecValTok{4}\NormalTok{], }\KeywordTok{list}\NormalTok{(Coredes}\OperatorTok{$}\NormalTok{COREDE), sum)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{06-Mapas_files/figure-latex/unnamed-chunk-13-1.pdf}
