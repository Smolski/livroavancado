...
\caption{Valores ajustados e preditos do número de satélites (Sa) em função do tamanho da carapaça (W)}\label{fig:unnamed-chunk-78}
\end{figure}
...
\caption{Valores observados e preditos}\label{fig:unnamed-chunk-83}
\end{figure}
