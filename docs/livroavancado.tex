...
{\centering \includegraphics[width=0.6\linewidth]{curvalog} 
...
busca maximizar a probabilidade de que um evento ocorra. A qualidade do
ajuste do modelo é avaliada pelo ``pseudo'' R\(^2\) e pelo exame da
precisão preditiva (matriz de confusão).
...
{\centering \includegraphics[width=0.6\linewidth]{05-RegLogist_files/figure-latex/dispev-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{05-RegLogist_files/figure-latex/distrpred-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{05-RegLogist_files/figure-latex/roc-1} 
...
\begin{center}\includegraphics[width=0.6\linewidth]{05-RegLogist_files/figure-latex/unnamed-chunk-26-1} \end{center}
