...
grupo de ``eventos'', o que pode distinguir a os resultados pretidos e
...
\ref{fig:curvalog}c demonstra um bom ajustena relação entre as
variáveis.
...
logística é rodado randômicamente e a predição resultante é comparada
...
probabilidades previstas em 10 grupos. A hipótese nula H\({_0}\) do
qui-quadrado (\texttt{p=0,05}) deste teste é a de que as proporções
observadas e esperadas são as mesmas ao longo da amostra. Abaixo segue a
estrutura do teste, sendo que o modelo apresenta dificuldade de ajuste
em função de que rejeita a hipótese nula a \emph{p=0,05}.
...
preditiva do mesmo. Para resolver esta questão, utiliza-se o teste do
fator de inflaçãod a variância (VIF - Variance Inflation Factor).
...
\hypertarget{exemplos-de-trabalhos-que-utilizaram-regressao-logistica}{%
\section{Exemplos de trabalhos que utilizaram regressão
logística}\label{exemplos-de-trabalhos-que-utilizaram-regressao-logistica}}

\begin{itemize}
\item
  \textbf{Uso da regressão logística na estimação da probabilidade de
  reincidência de jovens infratoras}.
  \url{http://bdm.unb.br/bitstream/10483/13133/1/2015_FelipeGomesRibeiro.pdf}
\item
  \textbf{Técnicas de Regressão Logística aplicada à Análise Ambiental}
  \url{http://www.uel.br/revistas/uel/index.php/geografia/article/download/6878/9676}
\item
  \textbf{Reincidência penal: uma análise a partir da e``conomia do
  crime'' para subsidiar decisões judiciais.}
  \url{http://177.101.17.124/index.php/sociais/article/download/6029/4134}
\end{itemize}
